    ...
    <HeroAvatar
      ...
      description={
        <div className="text-xl leading-8">
          Delicia is a skilled London-based
          ...
          With a strong eye for design and attention to detail, she creates
          visually stunning and intuitive user interfaces. Committed to
          excellence, Delicia delivers exceptional web experiences that surpass
          expectations.
        </div>
      }
      avatar={
